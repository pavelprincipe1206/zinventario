...
public abstract class ItemServiceImpl extends JPACustomServiceImpl<ItemResponse, Item, Integer> implements ItemService {
    ...
    protected final String validacionesPrevias(Item bean) throws Exception {
        String mensaje = "";
        if (!Optional.of(bean.getCantidad()).isPresent()) {
            String msg = this.messageSource.getMessage("message.item.cantidad.requerido", null, LocaleContextHolder.getLocale());
            mensaje += "* " + msg + "<br/>";
        }
    ...
    protected Item setUploadExcel(Cell currentCell, Item item, int contador) throws Exception {
        ...
        case 2:
            try {
                ...
                item.setCantidad(valorDouble.intValue());
            } catch (Exception e) {
        ...
        case 3:
            try {
                ...
                item.setPrecioUnitario(valorDecimal);
            } catch (Exception e) {
    ...
    protected int setAbstractDownloadExcelSXLSX(Item bean, Row dataRow, List<CellStyle> cellStyleList) {
        ...
        contador++;
        ExcelDefault.setValueCell(bean.getCantidad(), dataRow.createCell(contador), "I", cellStyleList);
        contador++;
